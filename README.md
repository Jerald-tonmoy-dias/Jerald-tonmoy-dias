...
- **Lead Frontend Developer** · SoftTech-IT · Jan 2021 – Oct 2023  
  ThemeForest templates, frontend team lead, REST integration
...
- Frontend architecture — reusable components, conventions, Storybook
- API integration on production products
- Headless CMS — Payload CMS, Sanity
- Leadership — mentoring, reviews, coordinating frontend delivery
...
React.js · Next.js · TypeScript · JavaScript · HTML/CSS/SASS · Tailwind CSS · Storybook · Payload CMS · Sanity · REST APIs · React Native · Git · Figma · Vercel

**Working knowledge**  
Node.js · Express · Laravel (API integration) · Prisma · Drizzle · MongoDB · MySQL · WordPress (customization) · Docker · PostgreSQL

**Currently developing**  
Python · FastAPI · Flask · pandas · scikit-learn · spaCy
